...
SECRET_KEY = 'django-insecure-899&o*koj1p(bajfb3t)rd=9q_a7v7r#pg9htihk07p18z(n7z'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE-NAME', 'trelloproject'),
        'USER': os.environ.get('DATABASE-USER', 'myprojectuser'),
